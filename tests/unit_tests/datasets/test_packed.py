...
class TestCollatedPacked:
    ...
    def test_collate_basic_batch(self):
        ...
        # Create mock packed samples with same tensor sizes (as expected from PackedDataset)
        batch = [
            {
...
class TestPackedDataset:
    ...
    def test_checkpoint_and_resume(self, dataset_factory):
        ...
        but does NOT expect identical batches after resumption. The PackedDataset
