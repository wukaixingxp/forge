...
class PackedDataset(InfiniteTuneIterableDataset, Generic[SampleType]):
    """
    ...
    Args:
        ...
        buffer_size (int): The number of samples to buffer for finding the
            ...
            Default is 100.
        dataset_name (str): The name of this packed dataset, used for metrics. Defaults to "PackedDataset".
    ...
    def __init__(
        ...
        buffer_size: int = 100,
        dataset_name: str = "PackedDataset",
    ):
        if buffer_size <= 0:
